...
export const MOCK_SENSORES: Record<number, SensorMock[]> = {
  1: [
    ...
    { posicion: 5,   columna: 'P3', fila: 'int_superior', id: 'T01 S05', valor: -47.9, habilitado: true },
    ...
    { posicion: 32,  columna: 'P4', fila: 'ext_inferior', id: 'T01 S16', valor: 31.5, habilitado: true },
